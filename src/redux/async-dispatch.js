...
export const identityResolver = x => x;
...
/*  if(payload.response && payload.response.data){
  ...
  return Promise.reject(payload) // we need to reject here !!
}


export default makePromiseDispatcher(identityResolver)(identityResolver);
